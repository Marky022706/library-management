...
-- Generated at: 2026-08-15 18:21:50
...
INSERT INTO borrowings (id, user_id, book_id, borrow_date, due_date, return_date, status, renew_count, fine_amount, processed_by, created_at, updated_at) VALUES ('brw-10862013', 'u-293d62ed', 'bk-6b443826', '2026-08-15', '2026-08-29', '2026-08-15', 'returned', '1', '0.00', 'u-8f771a19', '2026-08-16 02:21:50', '2026-08-16 02:21:50');
...
-- Table: reservations
INSERT INTO reservations (id, user_id, book_id, reserved_date, pickup_deadline, status, created_at, updated_at) VALUES ('res-2fba15a1', 'u-293d62ed', 'bk-6b443826', '2026-08-15', '2026-08-18', 'cancelled', '2026-08-16 02:21:50', '2026-08-16 02:21:50');
...
-- Table: attendance
INSERT INTO attendance (id, user_id, date, time_in, time_out, status, source, created_at, updated_at) VALUES ('att-5d02c042', 'u-293d62ed', '2026-08-15', '18:21:50', '18:21:50', 'left', 'QR_KIOSK', '2026-08-16 02:21:50', '2026-08-16 02:21:50');
...
INSERT INTO notifications (id, user_id, title, message, type, read_status, created_at) VALUES ('notif-4563a79c', 'u-293d62ed', 'Book Request Approved', 'Your acquisition request for \"Designing Data-Intensive Applications\" was approved: Approved for library purchase', 'success', '0', '2026-08-16 02:21:50');
INSERT INTO notifications (id, user_id, title, message, type, read_status, created_at) VALUES ('notif-50fc2dfd', 'u-293d62ed', 'Book Borrowed Successfully', 'You borrowed \"Design Patterns: Elements of Reusable Object-Oriented Software\". Due date is 2026-08-22.', 'due', '0', '2026-08-16 02:21:50');
INSERT INTO notifications (id, user_id, title, message, type, read_status, created_at) VALUES ('notif-728eea9f', 'u-293d62ed', 'Book Returned', 'Your copy of \"Design Patterns: Elements of Reusable Object-Oriented Software\" has been returned successfully.', 'success', '0', '2026-08-16 02:21:50');
INSERT INTO notifications (id, user_id, title, message, type, read_status, created_at) VALUES ('notif-7c257704', 'u-293d62ed', 'Loan Renewed', 'Loan for \"Design Patterns: Elements of Reusable Object-Oriented Software\" renewed. New due date is 2026-08-29.', 'info', '0', '2026-08-16 02:21:50');
INSERT INTO notifications (id, user_id, title, message, type, read_status, created_at) VALUES ('notif-9f0b9439', 'u-293d62ed', 'Test Alert', 'Your integration test notification is live.', 'info', '1', '2026-08-16 02:21:50');
INSERT INTO notifications (id, user_id, title, message, type, read_status, created_at) VALUES ('notif-a0104e5b', 'u-293d62ed', 'Reservation Ready for Pickup', 'Your copy of \"Design Patterns: Elements of Reusable Object-Oriented Software\" is now ready at the circulation counter until 2026-08-18.', 'reservation', '0', '2026-08-16 02:21:50');
...
INSERT INTO notifications (id, user_id, title, message, type, read_status, created_at) VALUES ('notif-c7799337', 'u-293d62ed', 'Reservation Hold Placed', 'Your reservation hold has been queued. You will be notified when a copy becomes available for pickup.', 'reservation', '0', '2026-08-16 02:21:50');
...
-- Table: announcements
INSERT INTO announcements (id, title, content, status, publish_date, expiration_date, created_by, created_at, updated_at) VALUES ('ann-1', 'Welcome to the Balingasag Public Library System', 'Students and faculty can now browse the book catalog, manage hold reservations, check attendance, and view digital library cards online.', 'published', '2026-08-15', NULL, NULL, '2026-08-16 02:21:50', '2026-08-16 02:21:50');

-- Table: favorites

-- Table: book_requests
INSERT INTO book_requests (id, user_id, request_type, book_id, title, author, publisher, isbn, reason, status, approver_id, remarks, created_at, updated_at) VALUES ('req-22845bdc', 'u-293d62ed', 'acquisition', NULL, 'Designing Data-Intensive Applications', 'Martin Kleppmann', NULL, NULL, 'Database research', 'approved', 'u-8f771a19', 'Approved for library purchase', '2026-08-16 02:21:50', '2026-08-16 02:21:50');
...
-- Table: audit_logs
INSERT INTO audit_logs (id, user_id, user_name, role, action, module, target_id, description, ip_address, status, created_at) VALUES ('aud-05964adc', 'u-8f771a19', 'Jose Reyes', 'admin', 'Borrow Book', 'Circulation', 'brw-10862013', 'Checked out book Design Patterns: Elements of Reusable Object-Oriented Software to user ID u-293d62ed', '127.0.0.1', 'Completed', '2026-08-16 02:21:50');
INSERT INTO audit_logs (id, user_id, user_name, role, action, module, target_id, description, ip_address, status, created_at) VALUES ('aud-1d4449eb', 'u-e586c11f', 'Elena Cruz', 'super_admin', 'Backup Database', 'System', 'balingasag_backup_20260815_182124.sql', 'Created full database backup balingasag_backup_20260815_182124.sql (15.83 KB)', '127.0.0.1', 'Completed', '2026-08-16 02:21:24');
...
INSERT INTO audit_logs (id, user_id, user_name, role, action, module, target_id, description, ip_address, status, created_at) VALUES ('aud-3082d43e', 'u-8f771a19', 'Jose Reyes', 'admin', 'Return Book', 'Circulation', 'brw-10862013', 'Processed return of Design Patterns: Elements of Reusable Object-Oriented Software', '127.0.0.1', 'Completed', '2026-08-16 02:21:50');
INSERT INTO audit_logs (id, user_id, user_name, role, action, module, target_id, description, ip_address, status, created_at) VALUES ('aud-32b566de', 'u-e586c11f', 'Elena Cruz', 'super_admin', 'Run Integration Test', 'Testing', NULL, 'Integration test executed successfully', '127.0.0.1', 'Completed', '2026-08-16 02:21:50');
...
INSERT INTO audit_logs (id, user_id, user_name, role, action, module, target_id, description, ip_address, status, created_at) VALUES ('aud-f901c14d', 'u-8f771a19', 'Jose Reyes', 'admin', 'Approved Request', 'Requests', 'req-22845bdc', 'Approved acquisition request for Designing Data-Intensive Applications', '127.0.0.1', 'Completed', '2026-08-16 02:21:50');
...
INSERT INTO system_logs (id, level, channel, message, context, created_at) VALUES ('syslog-85998933', 'info', 'system', 'Integration test pipeline health check passed', NULL, '2026-08-16 02:21:50');
...
-- Table: backups
INSERT INTO backups (id, filename, file_size, total_tables, status, created_by, created_at) VALUES ('bkp-20260815-182124', 'balingasag_backup_20260815_182124.sql', '15.83 KB', '20', 'Success', 'Elena Cruz', '2026-08-16 02:21:24');
