...
export const selectClasses =
  'w-full rounded-lg border border-gray-200 bg-white px-3 py-2.5 text-sm text-ink focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-100';
